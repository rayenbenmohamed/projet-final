                    ...
                    <div className="col-md-5 col-lg-4 order-md-last">
                        ...
                        <form className="card p-2">
                            <div className="input-group">
                                ...
                                <button type="submit" className="btn btn-secondary">Get it</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <form className="needs-validation" novalidate="">
                            <div className="row g-3">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="lastName" placeholder="last" value="" required="" />
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="text" className="form-control" id="address" placeholder="7170 Dahmani" required="" />
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="text" className="form-control" id="address2" placeholder="Rue Farhat Hached" />
                                </div>
